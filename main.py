...
preset_human_img = PhotoImage(file='assets/preset_who_starts_human.png')
preset_ai_img = PhotoImage(file='assets/preset_who_starts_ai.png')

preset_algorithm_img = PhotoImage(file='assets/preset_alg.png')
preset_alg_ab_img = PhotoImage(file='assets/preset_alg_alpha_beta.png')
preset_alg_mm_img = PhotoImage(file='assets/preset_alg_minimax.png')
preset_alg_hf_img = PhotoImage(file='assets/preset_alg_hf.png')
