...
def finish_menu(mode):
    ...
    exit_button = Button(root, image=Assets.final_exit_img, border=0, command=on_click_exit)
    start_again_button = Button(root, image=Assets.final_start_img, border=0, command=lambda: {})
    menu_bar = Button(root, image=Assets.final_menu_img, border=0, command=lambda: {})
...
def main_menu():
    ...
    start_button = Button(root, image=Assets.main_menu_start_img, border=0, command=to_preset_menu)
    start_button.place(x=275, y=263)
    exit_button = Button(root, image=Assets.main_menu_exit_img, border=0, command=on_click_exit)
...
background.pack()
who_starts_button = Button(root, image=Assets.preset_who_starts_img, border=0, command=change_player)
alg_button = Button(root, image=Assets.preset_algorithm_img, border=0, command=change_alg)
