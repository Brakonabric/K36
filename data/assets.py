...
class LoadAssets:
    ...
    final_defeat_bg_img = PhotoImage(file='assets/final/final_defeat_background.png')
    final_draw_bg_img = PhotoImage(file='assets/final/final_draw_background.png')
    final_victory_bg_img = PhotoImage(file='assets/final/final_victory_background.png')
